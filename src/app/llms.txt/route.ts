...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.st-blockade-battlefront.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'ST Blockade Battlefront Wiki'
